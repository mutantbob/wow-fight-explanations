...
CHAT(c, "Once the protector's health is <25% kite it off the platform because "..TotalAnnihilation.." plus "..StabilityFlux.." enhanced by "..TouchTitans.." is deadly.")
...
CHAT(c, "Drop "..Overcharge.." stacks before killing the Energy Charge because "..Discharge.." hurts.")
