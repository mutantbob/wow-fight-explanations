...
SendChatMessage("Dodge "..MoonLotus.." clouds.  Spread out for "..CosmicBarrage..".",c)
SendChatMessage("Spread out for "..LightOfDay.." and "..FlamesOfPassion..".",c)
SendChatMessage("Don't mess with "..CelestialAid.." animal pillars unless you know what you're doing.",c)
